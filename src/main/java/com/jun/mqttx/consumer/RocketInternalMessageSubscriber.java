...
/**
 * 集群消息订阅分发处理器, rocket 实现
 *
 * @since v1.0.6
 */
@Slf4j
public class RocketInternalMessageSubscriber extends AbstractInnerChannel implements ConsumerSeekAware {

    private volatile boolean onceFlag = false;

    public RocketInternalMessageSubscriber(List<Watcher> watchers, MqttxConfig mqttxConfig) {
